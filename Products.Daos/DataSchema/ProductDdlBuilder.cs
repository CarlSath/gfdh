...
namespace Products.Daos.DataSchema
{
	public class ProductDdlBuilder : DdlBuilder
	{
		...
		{
			return @"CREATE TABLE Product(Id int IDENTITY(1,1) PRIMARY KEY NOT NULL,Description nvarchar(255),CatalogId nvarchar(255),Name nvarchar(255),OwnerId nvarchar(255),Description nvarchar(255),Owner_Id int,Entity_Status int)";
		}
